...
# Creamos una carpeta para la aplicacion y cambiamos al directorio app
sudo mkdir -p /home/vagrant/app 
sudo cp /vagrant/pom.xml  app/tomcat-war/
cd /home/vagrant/app

# Ejecutamos el comando Maven en el directorio app de manera no interactiva
